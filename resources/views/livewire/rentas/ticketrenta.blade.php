             ...
             <div class="row mt-4">                     
                ...
                <div class="form-group col-lg-4 col-md-4 col-sm-12">
                    ...
                    <div class="input-group mb-2 mr-sm-2">
                        ...
                        <input type="text" wire:model.lazy="nombre"  class="form-control" maxlength="30"  placeholder="ej: Carlos">
                    </div>
                ...
                <div class="form-group col-lg-4 col-md-4 col-sm-12">
                    ...
                    <div class="input-group mb-2 mr-sm-2">
                        ...
                        <input type="text" wire:model.lazy="email" class="form-control"  placeholder="ej: carlos@gmail.com">
                    </div>
                </div>
                ...
                <div class="form-group col-lg-4 col-md-4 col-sm-12">
                    <h7 class="text-info">Observaciones</h7>
                    <div class="input-group mb-2 mr-sm-2">
                        <div class="input-group-prepend">
                            <div class="input-group-text"><i class="la la-edit la-lg"></i></div>
                        </div>
                        <input type="text" wire:model.lazy="concepto_multa" class="form-control"  placeholder="ej: multa por vencimiento $50.00">
                    </div>
                </div>
            </div> 
            ...
            <div class="row">
                ...
                <div class="col-md-2 col-lg-2 col-sm-12">
                    <div class="form-group mb-0" >Total Calculado
                     <input  class="form-control total" type="text" disabled value="${{number_format($totalCalculado,2)}}" >
                 </div>
             </div>                         
             <div class="col-md-3 col-lg-3 col-sm-12">
            ...
            <div class="col-md-4 col-lg-4 col-sm-12 text-right">              
                <div class="n-chk mt-4">
                    <label class="new-control new-checkbox checkbox-primary">
                      <input wire:model="printTicket" type="checkbox" class="new-control-input" checked>
